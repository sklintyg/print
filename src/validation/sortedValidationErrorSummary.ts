import { Certificate, CertificateData } from "../types/certificate.types";
import {
  CertificateDataElement,
  ConfigTypes,
} from "../types/certificateElement.types";
import { ValidationError } from "../types/certificateValidation.types";
...
const getCategoryValidationErrors = (
  data: CertificateData
): ValidationErrorSummary[] => {
  const getCategory = (
    element: CertificateDataElement
  ): CertificateDataElement | undefined => {
    return element.config.type === ConfigTypes.CATEGORY
      ? element
      : getCategory(data[element.parent]);
  };
...
const getCareUnitValidationErrors = (
...
function getPatientValidationErrors(
